        ...
        <Card>
            <CardContent>
                <Typography variant="h6" sx={{ mb: 1.2 }}>
                    Hoá đơn nâng cấp thành viên
                </Typography>
                <Typography color="text.secondary" sx={{ mb: 1.6 }}>
                    Cả người dùng và thủ thư đều có thể theo dõi hoá đơn nâng cấp, gia hạn, hoặc tự hạ cấp do hết hạn.
                </Typography>
                <Table size="small">
                    <TableHead>
                        <TableRow>
                    ...
                    <TableBody>
                        {transactions.length === 0 && (
                            <TableRow>
                                <TableCell colSpan={8}>Chưa có hoá đơn membership.</TableCell>
                            </TableRow>
                        )}
                        {transactions.map((tx) => (
                            <TableRow key={tx.id}>
                                <TableCell>{`HD-${tx.id}`}</TableCell>
